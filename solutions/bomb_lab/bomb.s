...
00000000004010f4 <phase_6>:
  ...
  401100:	49 89 e5             	mov    %rsp,%r13 ;*p=a
  401103:	48 89 e6             	mov    %rsp,%rsi ;*q=a
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>
  40110b:	49 89 e6             	mov    %rsp,%r14 ; *r=a
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d;i = 0

.L1
  401114:	4c 89 ed             	mov    %r13,%rbp ;*s=p
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34> ;a[0] <= 6
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d ; i = i+1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d 
  401130:	74 21                	je     401153 <phase_6+0x5f>; if (i!=6)
  401132:	44 89 e3             	mov    %r12d,%ebx ; j = i
.L2
  401135:	48 63 c3             	movslq %ebx,%rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax; 
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51> ;if(a[i] != s)
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx   ;j = j+1
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41>; if(j <= 5)
  40114d:	49 83 c5 04          	add    $0x4,%r13            ; p = p + 1
...
.L3
  ...
  40116f:	be 00 00 00 00       	mov    $0x0,%esi;i = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
.L4
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx;st = st->next
  40117a:	83 c0 01             	add    $0x1,%eax ;k = k+1
  40117d:	39 c8                	cmp    %ecx,%eax ;a[0]==1
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
.L5
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx ;st = 0x6032d0
.L6
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2);b[i] = st
...
.L7
  ...
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>;a[i]<=1;
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax ;int k = 0
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx ;struct *st=0x6032d0
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>
.L8
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx; st *x=b[0]
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax; B *y = &b[1]
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi; B *end = &b[6]
  4011ba:	48 89 d9             	mov    %rbx,%rcx      ;st *rcx = b[0]
  4011bd:	48 8b 10             	mov    (%rax),%rdx    ;st *rdx = b[i+1]
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) ;b[i]->next = b[i+1]
  4011c4:	48 83 c0 08          	add    $0x8,%rax      ;y = y+1
  4011c8:	48 39 f0             	cmp    %rsi,%rax 
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>;if(y==end)
  4011cd:	48 89 d1             	mov    %rdx,%rcx      ;rcx = b[i]
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx) ;
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax ;rax = b[1];
